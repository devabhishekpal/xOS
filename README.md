...
It was made in hopes of helping others get a base to write their own OS.
It also exhibits how the low level programs interact with higher level C programs and how the booting process works.
It also implements GUI and commands to show the implementation of VGA for graphics and other features.

## Get Started
For those who want to simply run the project, just execute the  ```build_and_run.sh``` script.

### Prerequisites

	grub-mkrescue -> To create ISO file
	qemu-system-x86 -> To emulate the OS
